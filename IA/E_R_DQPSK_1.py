...
# Title: E R Dqpsk 1
# Generated: Thu Feb 21 15:35:17 2019
##################################################
...
class E_R_DQPSK_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "E R Dqpsk 1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("E R Dqpsk 1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "E_R_DQPSK_1")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(4), 0.35, 11*4*nfilts)
        ...
        self._volume_win = RangeWidget(self._volume_range, self.set_volume, 'Volume reception', "counter_slider", float)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_1_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_sin_range = Range(100, 4000, 100, 1000, 50)
        self._freq_sin_win = RangeWidget(self._freq_sin_range, self.set_freq_sin, 'Frequence son emmission', "counter_slider", float)
        self.top_grid_layout.addWidget(self._freq_sin_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, 0.35, (rrc_taps), nfilts, nfilts/2, 1.5, 1)
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vff((0.5, ))
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc((0.707+0.707j, ))
        ...
        self.connect((self.blks2_packet_decoder_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.digital_psk_demod_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_throttle_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.audio_sink_0, 0))
    ...
    def set_nfilts(self, nfilts):
        self.nfilts = nfilts
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts, self.nfilts, 1.0/float(4), 0.35, 11*4*self.nfilts))
...
def main(top_block_cls=E_R_DQPSK_1, options=None):
